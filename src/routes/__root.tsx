...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SmartPDFTools — Every PDF tool you need, in one smart workspace" },
      { name: "description", content: "Free online PDF tools to merge, split, compress, convert, edit, sign, OCR and unlock PDFs. Plus AI-powered document tools. Fast, secure, no install." },
      { name: "keywords", content: "PDF tools, merge PDF, split PDF, compress PDF, PDF to Word, Word to PDF, edit PDF, OCR, AI PDF" },
      { name: "author", content: "SmartPDFTools" },
      { name: "robots", content: "index, follow" },
      { property: "og:title", content: "SmartPDFTools — Every PDF tool you need, in one smart workspace" },
      { property: "og:description", content: "Free online PDF tools to merge, split, compress, convert, edit, sign, OCR and unlock PDFs. Plus AI-powered document tools. Fast, secure, no install." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "SmartPDFTools" },
    ...
    links: [
      ...
      { rel: "canonical", href: "https://smartpdftools.com/" },
    ],
    scripts: [
      {
