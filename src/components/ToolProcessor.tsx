...
const badgeStyles: Record<string, string> = {
  شائع: "bg-amber-500/15 text-amber-600 dark:text-amber-400"،
  جديد: "bg-emerald-500/15 text-emerald-600 dark:text-emerald-400",
  الذكاء الاصطناعي: "bg-gradient-primary text-primary-foreground"،
};

// معاينات SVG ثلاثية الأبعاد مع تدرجات وظلال لكل أداة
const toolPreviews: Record<string, ReactNode> = {
  دمج ملفات PDF: (
    <svg viewBox="0 0 160 90" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <defs>
        <linearGradient id="mg-bg" x1="0" y1="0" x2="160" y2="90" gradientUnits="userSpaceOnUse">
          <stop stopColor="#fff1f2" /><إيقاف الإزاحة = "1" stopColor = "#ffe4e6" />
        </linearGradient>
        ...
        <linearGradient id="mg-card2" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#fb7185" /><إيقاف الإزاحة = "1" stopColor = "#e11d48" />
        </linearGradient>
        <linearGradient id="mg-result" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#fff1f2" /><إيقاف الإزاحة = "1" stopColor = "#fda4af" />
        </linearGradient>
    ...
    <svg viewBox="0 0 160 90" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <defs>
        ...
        <linearGradient id="cp-big" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#fcd34d" /><إيقاف الإزاحة = "1" stopColor = "#f59e0b" />
        </linearGradient>
        <linearGradient id="cp-small" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#fbbf24" /><إيقاف الإزاحة = "1" stopColor = "#d97706" />
        </linearGradient>
      ...
      <g filter="url(#cp-shadow)">
        ...
        <text x="8" y="74" fontSize="9" fill="white" fontWeight="bold" fillOpacity="0.9">12 ميجابايت</text>
      </g>
      <g>
      ...
      <g filter="url(#cp-shadow2)">
        ...
        <text x="102" y="60" fontSize="9" fill="white" fontWeight="bold" fillOpacity="0.9">1.2 ميجابايت</text>
      </g>
      <circle cx="127" cy="14" r="8" fill="#16a34a" />
      <text x="121" y="18" fontSize="10" fill="white" fontWeight="bold">â†“</text>
      <text x="107" y="72" fontSize="6" fill="#92400e" fontWeight="bold">أصغر بنسبة 90%</text>
    </svg>
  )
  "تدوير ملف PDF": (
    <svg viewBox="0 0 160 90" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <defs>
        ...
        <linearGradient id="rp-wrong" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#d8b4fe" /><إيقاف الإزاحة = "1" stopColor = "#9333ea" />
        </linearGradient>
        <linearGradient id="rp-right" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#e9d5ff" /><إيقاف الإزاحة = "1" stopColor = "#a855f7" />
        </linearGradient>
      ...
      <g filter="url(#rp-shadow)">
        ...
        <text x="8" y="70" fontSize="6" fill="#7e22ce" fontWeight="bold">جانبيًا</text>
      </g>
      <g>
    ...
    <svg viewBox="0 0 160 90" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <defs>
        ...
        <linearGradient id="sp-main" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#fdba74" /><إيقاف الإزاحة = "1" stopColor = "#f97316" />
        </linearGradient>
      ...
      <g filter="url(#sp-shadow2)">
        ...
        <text x="92" y="10" fontSize="5.5" fill="white" fontWeight="bold">الجزء 1</text>
      ...
      <g filter="url(#sp-shadow2)">
        ...
        <text x="92" y="40" fontSize="5.5" fill="white" fontWeight="bold">الجزء الثاني</text>
      ...
      <g filter="url(#sp-shadow2)">
        ...
        <text x="92" y="70" fontSize="5.5" fill="white" fontWeight="bold">الجزء 3</text>
    ...
    <svg viewBox="0 0 160 90" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <defs>
        ...
        <linearGradient id="dp-main" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#fca5a5" /><إيقاف الإزاحة = "1" stopColor = "#dc2626" />
        </linearGradient>
    ...
    <svg viewBox="0 0 160 90" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <defs>
        <linearGradient id="wm-bg" x1="0" y1="0" x2="160" y2="90" gradientUnits="userSpaceOnUse">
          <stop stopColor="#ecfeff" /><stop offset="1" stopColor="#cfffafe" />
        </linearGradient>
        <linearGradient id="wm-main" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#67e8f9" /><إيقاف الإزاحة="1" stopColor="#0891b2" />
        </linearGradient>
    ...
    <svg viewBox="0 0 160 90" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <defs>
        <linearGradient id="pw-bg" x1="0" y1="0" x2="160" y2="90" gradientUnits="userSpaceOnUse">
          <stop stopColor="#eff6ff" /><إيقاف الإزاحة = "1" stopColor = "#dbeafe" />
        </linearGradient>
      ...
      <g filter="url(#pw-shadow)">
        ...
        <text x="106" y="77" fontSize="6" fill="#1e3a8a" fontWeight="bold">.DOCX — قابل للتعديل</text>
      </g>
    </svg>
  )
  "تحويل jpg إلى pdf": (
    <svg viewBox="0 0 160 90" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <defs>
        <linearGradient id="jp-bg" x1="0" y1="0" x2="160" y2="90" gradientUnits="userSpaceOnUse">
          <stop stopColor="#f0fdf4" /><إيقاف الإزاحة = "1" stopColor = "#dcfce7" />
        </linearGradient>
        <linearGradient id="jp-img1" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#86efac" /><إيقاف الإزاحة="1" stopColor="#16a34a" />
        </linearGradient>
        <linearGradient id="jp-img2" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#4ade80" /><إيقاف الإزاحة = "1" stopColor = "#15803d" />
        </linearGradient>
        <linearGradient id="jp-pdf" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#bbf7d0" /><إيقاف الإزاحة = "1" stopColor = "#22c55e" />
        </linearGradient>
  ...
  "تحويل ملفات PDF إلى صور JPG": (
    <svg viewBox="0 0 160 90" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <defs>
        <linearGradient id="pj-bg" x1="0" y1="0" x2="160" y2="90" gradientUnits="userSpaceOnUse">
          <stop stopColor="#fdf2f8" /><إيقاف الإزاحة = "1" stopColor = "#fce7f3" />
        </linearGradient>
        <linearGradient id="pj-pdf" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#fbcfe8" /><إيقاف الإزاحة = "1" stopColor = "#ec4899" />
        </linearGradient>
        <linearGradient id="pj-img" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#f9a8d4" /><إيقاف الإزاحة = "1" stopColor = "#db2777" />
        </linearGradient>
  ...
  "تحويل الكلمات إلى PDF": (
    <svg viewBox="0 0 160 90" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <defs>
        <linearGradient id="wp-bg" x1="0" y1="0" x2="160" y2="90" gradientUnits="userSpaceOnUse">
          <stop stopColor="#eef2ff" /><إيقاف الإزاحة = "1" stopColor = "#e0e7ff" />
        </linearGradient>
        <linearGradient id="wp-word" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#a5b4fc" /><إيقاف الإزاحة = "1" stopColor = "#4f46e5" />
        </linearGradient>
        <linearGradient id="wp-pdf" x1="0" y1="0" x2="1" y2="1">
          <stop stopColor="#c7d2fe" /><إيقاف الإزاحة = "1" stopColor = "#6366f1" />
        </linearGradient>
  ...
  يعود (
    ...
    >
      <motion.div
        ...
        whileTap={{ scale: 0.98 }}
        transition={{ type: "spring", rigidness: 300, damping: 20 }}
        className="flex flex-col h-full"
      >
        <رابط
          إلى="/tools/$slug"
        ...
        >
          ...
          {معاينة؟ (
            <div
              ...
              role="img"
              aria-label={`${tool.title.en} — أداة PDF مجانية عبر الإنترنت`}
            >
              {معاينة}
            </div>
          ) : (
          ...
          <div className="p-5 flex flex-col flex-1">
            ...
            <div className="inline-flex items-center gap-1.5 text-sm font-semibold text-primary opacity-0 group-hover:opacity-100 transition-opacity duration-200">
              {لانج === "ar" ؟ "ط§ط¨ط¯ط £ ط§ظ„ط¢ظ†" : "فتح الأداة"}
      ...
      {tool.relatedArticle && (
        <motion.div
          whileHover={{ y: -2 }}
          transition={{ type: "spring", rigidness: 400, damping: 25 }}
        >
          <رابط
            to="/blog/$slug"
          ...
          >
            ...
            <span className="line-clamp-1 flex-1">
              {لانج === "ar" ؟ "ط§ظ‚ط±ط £ ط§ظ„ط¯ظ„ظٹظ„: " : "اقرأ الدليل: "}
