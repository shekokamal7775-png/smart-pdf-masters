...
const en: Dict = {
  ...
  "hero.subtitle":
    "Merge PDFs, compress files, convert PDF to Word, and turn PNG or JPG images into PDF — fast, private, and ready to download instantly.",
  ...
  "feature.fast.desc":
    "Optimised processing pipelines deliver results in seconds, even on large files.",
  ...
  "feature.ai.desc":
    "Only the four essential tools stay active, keeping the workspace simple and reliable.",
  ...
  "section.how.step2.desc":
    "Merge, compress, convert to Word, or create a PDF from PNG/JPG images.",
...
const ar: Dict = {
  ...
  "hero.subtitle":
    "ادمج PDF، اضغط الملفات، حوّل PDF إلى Word، وحوّل صور PNG أو JPG إلى PDF — بسرعة وخصوصية وتحميل فوري.",
