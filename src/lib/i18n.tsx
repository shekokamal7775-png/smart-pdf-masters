...
const en: Dict = {
  ...
  "hero.badge": "16+ powerful tools · 100% secure",
  "hero.title": "Every PDF tool you need, in one smart workspace",
  "hero.subtitle": "Merge, split, compress, convert, edit, sign and unlock PDFs — plus AI-powered tools that actually understand your documents. Free to start, secure by design.",
  ...
  "tools.subheading": "Every tool runs in your browser. Files are encrypted in transit and deleted automatically.",
  ...
  "feature.ai.title": "AI superpowers",
  "feature.ai.desc": "Summarise, translate, chat with PDFs and extract data with one click.",
  ...
  "section.how.step2.desc": "Convert, edit, compress, sign — over 16 tools available.",
...
const ar: Dict = {
  ...
  "hero.badge": "أكثر من 16 أداة قوية · آمنة 100%",
  "hero.title": "كل أدوات PDF التي تحتاجها في مكان واحد ذكي",
  "hero.subtitle": "ادمج، قسّم، اضغط، حوّل، عدّل، وقّع، وافتح ملفات PDF — بالإضافة إلى أدوات ذكاء اصطناعي تفهم مستنداتك. ابدأ مجاناً.",
  ...
  "tools.subheading": "كل أداة تعمل في متصفحك. الملفات مشفرة وتُحذف تلقائياً.",
  ...
  "feature.ai.title": "قوى الذكاء الاصطناعي",
  "feature.ai.desc": "لخّص، ترجم، تحدث مع ملفات PDF واستخرج البيانات بنقرة واحدة.",
  ...
  "section.how.step2.desc": "حوّل، عدّل، اضغط، وقّع — أكثر من 16 أداة متاحة.",
